...
type HapticType = "light" | "medium" | "heavy" | "selection" | "success" | "warning" | "error" | "none";
...
export function AppPressable({
  ...
  return (
    <Pressable
      ...
      style={[
        ensureMinTouchArea && { minHeight: accessibility.minTapTarget, minWidth: accessibility.minTapTarget, justifyContent: 'center' },
        style
      ]}
      {...props}
    >
