...
// Edge Function URL
const UPLOAD_FUNCTION_URL = `${process.env.EXPO_PUBLIC_SUPABASE_URL}/functions/v1/upload-image`;
...
export function useImageUpload(options: Partial<ImageUploadOptions> = {}) {
  ...
  }, [mergedOptions.allowsEditing, mergedOptions.aspect, mergedOptions.quality, requestMediaLibraryPermission]);
  ...
  }, [mergedOptions.allowsEditing, mergedOptions.aspect, mergedOptions.quality, requestCameraPermission]);
