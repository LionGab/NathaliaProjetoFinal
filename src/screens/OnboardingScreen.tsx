...
export default function OnboardingScreen() {
  ...
  const renderWelcome = () => (
    ...
    >
      ...
      <Pressable
        ...
        accessibilityHint="Inicia o processo de configuração do perfil"
      >
  ...
  const renderNameStep = () => (
    ...
    >
      <Text
        className="text-3xl font-serif text-warmGray-800 mb-3"
      ...
      <TextInput
        ...
        accessibilityHint="Digite seu nome para personalizar a experiência"
      />
      <Pressable
      ...
      <View className="space-y-4">
        {STAGES.map((stage) => (
          <Pressable
            ...
            accessibilityState={{ selected: data.stage === stage.id }}
          >
  ...
  const renderAgeStep = () => (
    ...
    >
      ...
      <TextInput
        ...
        accessibilityHint="Digite sua idade em anos"
      />
      <Pressable
  ...
  const renderLocationStep = () => (
    ...
    >
      ...
      <TextInput
        ...
        accessibilityHint="Digite sua cidade e estado"
      />
      <Pressable
